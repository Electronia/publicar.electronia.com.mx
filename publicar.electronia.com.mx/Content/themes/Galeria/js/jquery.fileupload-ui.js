...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
			...
			//alert("Aqui comienza el envio de las fotografias ");
                var that = $(this).data('fileupload');
                if (!data.isValidated) {
					//alert("creo que no es valida");
                    if (!data.isAdjusted) {
				...
				//alert("ok ahora entonces vamos a enviar");
